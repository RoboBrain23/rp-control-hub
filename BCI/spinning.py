...
class SpinningCircle(pygame.surface.Surface):
    ...
    def __init__(self, radius, color, speed=0.5):
        ...
        self.angle = 0
        self.speed = speed
        self.thickness = int(self.radius / 4.)
        self.portion = 360
        self.update()
    ...
    def update(self):
        ...
        pygame.draw.arc(self, self.color, (self.thickness, self.thickness, self.radius*2 - self.thickness*2, self.radius*2 - self.thickness*2), 0, angle, self.thickness)
